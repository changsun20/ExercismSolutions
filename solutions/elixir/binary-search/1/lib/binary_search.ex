defmodule BinarySearch do
  ...
  defp binary_search(numbers, key, left, right) when left > right do
    :not_found
  end
  defp binary_search(numbers, key, left, right) do
    ...
    cond do
      ...
      middle_value > key -> binary_search(numbers, key, left, middle_index - 1)
      middle_value < key -> binary_search(numbers, key, middle_index + 1, right)
    end
  end
end
